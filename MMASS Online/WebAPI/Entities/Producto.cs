...
namespace WebApi.Entities
{
    public class Producto
    {
        ...
        //public static Producto getProducto(DataRow item)            
        //{
        ...
        public static Producto getById(int Id)
        {
            ...
            if (t.Rows.Count == 1)
            {
                resultado = getProducto(t.Rows[0]);
            }
            return resultado;
        }
        ...
        //{
        //    string sqlCommand = "select p.id_producto, desc_producto, p.es_borrado, p.alias_producto, p.no_vinculable, p.email, p.fecha_modificacion, p.transferido, " +
        //                        " p.id_imagen_marca from productos p " +
        ...
        public static List<Producto> GetProductosPorAnunciante(int IdAnunciante)
        {
            string sqlCommand = "select p.id_producto, desc_producto, p.es_borrado, p.alias_producto, p.no_vinculable, p.email, p.Fecha_modificacion, " +
                                " c.id_competitivo, c.desc_competitivo, " +
                                " p.id_imagen_marca, im.desc_tabla as image_marca, " +
